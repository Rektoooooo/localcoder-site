  ...
  return (
    <section className="relative py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <RevealStagger className="mt-16 grid gap-px overflow-hidden rounded-2xl border border-border/60 bg-border/60 md:grid-cols-2 lg:grid-cols-4">
          {steps.map(({ icon: Icon, num, title, body }) => (
            <RevealItem
              key={num}
              className="group relative flex h-full flex-col gap-6 bg-background p-8 transition-colors hover:bg-surface/60"
            >
